...
string szyfrowanie(string szyfrogram) //funkcja szyfruj¹ca  
{
	...
	int przesun;
	cout<<"Przesun o: ";
	cin>>przesun; //podajemy o ile miejsc ma siê przesun¹æ w prawo (nale¿y podaæ sta³¹ liczbê)
...
string deszyfrowanie(string szyfrogram) //funkcja deszyfruj¹ca
{
	...
	int przesun;
	cout<<"Przesun o: ";
	cin>>przesun; //podajemy o ile miejsc ma siê przesun¹æ w lewo (nale¿y podaæ sta³¹ liczbê)
	for(int i=0; i<szyfrogram[i]; i++)
	{
