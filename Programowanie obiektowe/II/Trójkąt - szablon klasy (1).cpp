...
template <typename T, typename V, typename B>//T - double, V - void, B - bool
class Trojkat {

	private: 
		Punkt <double> w1, w2, w3; //punkty z wspolrzednymi z "struct Punkt" ((xx i yy)

	public: 
		T a, b, c; //boki trojkata wyliczone z podanych wspolrzednych punktow (z metody "setOdcinki()")

	V setW1(T x, T y) //ustawianie wartosci wspolrzednych (x, y) dla punktow (wierzcholkow) trojkata - konstruktor bezparametrowy
	{
		w1.xx = x;
		w1.yy = y;
	}
	...
	//private:
		...
		V setOdcinki() //ustawianie dlugosci bokow
		{
	...
	//public:
		B isTrojkat() //zwraca wartosc prawdziwa lub falszywa
		{
...
int main()
{
	Trojkat <double,void,bool> t1 = Trojkat<double,void,bool>();
	cout<<"Trojkat I: "<<endl;
	if(t1.isTrojkat())
	{
	...
	Trojkat <double,void,bool>t2 = Trojkat<double,void,bool>(p01, p02, p03);
	...
	Trojkat <double,void,bool> t3 = Trojkat<double,void,bool>(0,0,5,0,5,7); //wspolrzedne
